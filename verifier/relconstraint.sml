...
struct
  ...
  *)		    		
  ...
  (*fun lequate_cs rel_env g c funflag recordIndex con conrecordIndex variance (f1, f2) = 
    case variance of
          RF.RInvariant => [make_lc c (SubRFrame(env,g,f1,f2)) funflag recordIndex con conrecordIndex, 
                    make_lc c (SubRFrame(rel_envf2,f1)) funflag recordIndex con conrecordIndex]
        | RF.RCovariant => [make_lc c (SubRFrame(env,g,f1,f2)) funflag recordIndex con conrecordIndex]
        | RF.RContravariant => [make_lc c (SubRFrame(env,g,f2,f1)) funflag recordIndex con conrecordIndex]*)
